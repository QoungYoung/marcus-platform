...
- 同日 7/39=**17.9%**；±5 日（含切换通道）**35/39=89.7%**；8/8 事件 aligned（avg 89.6%）。注：只看 254/253 低吸/T 通道为 29/39=74.4%。
...
| 主线内切换下沉个股级（E09-E12 v0.2，r20） | ✅ 回测 | backtest_rotation_switch_stock.py；E09/E10/E11/E12 全部 executed，v2 89.7% |
