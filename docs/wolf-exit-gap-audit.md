...
| **G1** | 顶部判据做宽：放量上影线 ≥2×10 日均量 / 银保长上影+放量+大盘缩量 | 2025-05-06 / 2025-05-15 | ⏳ 待办 | C1 的"顶部阶段"目前只用上证 120 日分位（实测 pos=0.259 < 0.8 → 中轨腿现在不会触发） |
| **G2** | 个股止盈点 = 前一波拉升幅度的 0.618 位 | 2025-04-23 | ⏳ 待办 | 进阶段 1 变体池 |
| **G3** | 破线卖出后"删票"（移出观察池） | 2025-02-06 / 2025-04-03 | ⏳ 待办 | 建议带 TTL，别永久拉黑 |
| **G4** | 被动止盈"只上移、不破不卖" | 2025-06-09 / 2025-07-17 | ⏳ 待办 | 与"删自造机制"不冲突（他有原话） |
...
- 仍待做：C1 的中轨腿因"顶部阶段"不满足而休眠（G1 待做）。
