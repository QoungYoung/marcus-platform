...
| A5 | 2026-08-05 | A | mixed | -/-/- | no-data | 半导体概念=MID(in,新高回落); 第四代半导体=MID(in,新高回落) |
...
| D5 | 2026-05-26 | D | build | -/-/- | no-data |  |
| D6 | 2026-08-03 | D | tside | -/-/- | no-data |  |
