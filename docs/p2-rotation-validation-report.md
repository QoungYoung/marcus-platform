...
| A4 | 2026-05-25 | A | exit | d3/3-5/exit | OK | 存储芯片=HIGH(in,flat) |
| A5 | 2026-08-05 | A | mixed | d2/ABC/side | na | 半导体概念=MID(in,新高回落); 第四代半导体=MID(in,新高回落) |
| A6 | 2026-08-12 | A | tside | d4/4-4/t_only | OK | 创新药=MID(out,B反) |
