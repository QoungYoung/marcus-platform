...
THEME_CONCEPTS = {
  ...
  "半导体/芯片": ["半导体概念","国产芯片","存储芯片","光刻机(胶)","光刻胶","Chiplet概念","第三代半导体","第四代半导体","汽车芯片","AI芯片"],
  "新能源/电池": ["固态电池","锂电池","储能","电池技术","新能源","新能源车"],
  "军工/航天": ["商业航天","卫星互联网","航天航空","低空经济","无人机","军工"],
  "资源/周期": ["黄金概念","稀土永磁","锂矿概念"],
  "金融": ["券商概念","参股券商","参股银行","券商金股"],
  "消费/内需": ["白酒","免税概念","新消费","新零售","零售概念","旅游概念","消费电子概念","文娱消费"],
  "医药": ["创新药","中药概念","CRO","减肥药","医疗器械概念","生物疫苗","精准医疗","互联医疗","AI制药（医疗）"],
  "稳增长/基建": ["一带一路","中字头","铁路基建"],
  # 2026-09-08 扩容（孤儿概念盘点后补入主流板块）：机器人/汽车/传媒游戏/电力公用/农业
  "机器人/智能制造": ["机器人概念","人形机器人","机器人执行器","虚拟机器人","工业母机","3D打印","工程机械概念"],
  "汽车/智驾": ["汽车整车","华为汽车","小米汽车","无人驾驶","车联网(车路云)","汽车一体化压铸","汽车热管理","飞行汽车(eVTOL)"],
  "传媒/游戏": ["网络游戏","短剧互动游戏","影视概念","在线教育","职业教育","体育产业"],
  "电力/公用": ["核能核电","特高压","绿色电力","节能环保","雅下水电概念"],
  "农业": ["农业种植","水产养殖","农药兽药","粮食概念","生态农业","乳业","乡村振兴"],
}
