...
const PANEL_MEMBERS: PanelMember[] = [
  {
    ...
    thinkingLevel: 'high',
    systemPrompt: PANEL_RISK_CONTROLLER_PROMPT,
  ...
  },
  {
    ...
    systemPrompt: PANEL_TREND_TRADER_PROMPT,
    apiKey: DEEPSEEK_API_KEY,
  },
  {
    role: 'data_analyst',
    ...
    thinkingLevel: 'medium',
    systemPrompt: PANEL_DATA_ANALYST_PROMPT,
  ...
  },
  {
    ...
    thinkingLevel: 'medium',
    systemPrompt: PANEL_DEVILS_ADVOCATE_PROMPT,
    apiKey: MINIMAX_API_KEY,
  },
  {
    role: 'moderator',
    ...
    modelId: 'deepseek-v4-pro',
    thinkingLevel: 'high',
    systemPrompt: PANEL_MODERATOR_PROMPT,
    apiKey: DEEPSEEK_API_KEY,
  },
];
