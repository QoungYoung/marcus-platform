...
from app.services.golden_pit_config import CHINA_INDICES
...
def get_history(index: str = "all", days: int = 60) -> Dict[str, Any]:
    ...
    try:
        ...
        codes = [code for code in CHINA_INDICES if index == "all" or code == index]
        if not codes:
            return {
        ...
        for code in codes:
            ...
            result_indices[code] = CHINA_INDICES[code]["name"]
