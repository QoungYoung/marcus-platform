...
**9:50 中游跟进**：中游/配套环节建仓。此刻上游已运行 15 分钟，可确认其站稳。买入计划中的中游标的（如有），检查中游技术面。

**10:35 午前窗口**：产业链收尾 + 趋势确认。评估已建仓标的走势，不符合预期的止损；如 9:35/9:50 尚未完成全部产业链覆盖，在此时段完成下游建仓。
