...
- [x] 5.1 用 #71 同窗口（2026-08-05~08-14，震荡市模式）重跑，对比止损卖飞次数与组合收益
- [x] 5.2 参数敏感性：守卫全关 vs 仅收盘确认 vs 全开，对比卖飞率/收益
- [x] 5.3 用 2026-05-18~05-29 等历史窗口回归验证，避免单窗口过拟合
- [x] 5.4 提交、推送、部署，核对任务报告与事件流
