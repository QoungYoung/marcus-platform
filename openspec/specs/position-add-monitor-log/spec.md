...
PositionAddMonitorLog persistence — records every position-add monitoring check result to PostgreSQL for page display and audit. Covers tier evaluation outcomes, gate arbitration details, trend strength indicators, and execution results.
