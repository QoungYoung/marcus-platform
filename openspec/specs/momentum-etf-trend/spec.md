...
Define the t-account technology ETF momentum-trend short-line signal: 20-day momentum TOP3 equal-weight with biweekly (10 trading day) rotation, gated by the arkvol tech-hardware greed 250-day percentile (overheated >0.9 → skip), without independent stop-loss; isolated to account_id='t'.
# Spec: t 账户科技 ETF 动量趋势（momentum-etf-trend）
